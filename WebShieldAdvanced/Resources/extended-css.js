...
var ExtendedCss = (() => {
  ...
  var tokenizeAttribute = (attribute) => {
  ...
  var getRegularSelectorNodes = (children) => {
  ...
  var isSupportedPseudoClass = (tokenValue) => {
    return SUPPORTED_PSEUDO_CLASSES.includes(tokenValue);
  };
  var isOptimizationPseudoClass = (name) => {
  ...
  var isAttributeOpening = (tokenValue, prevTokenValue) => {
  ...
  var isAbsolutePseudoClass = (str) => {
    return ABSOLUTE_PSEUDO_CLASSES.includes(str);
  };
  var isRelativePseudoClass = (str) => {
  ...
  var optimizeCurrentRegularSelector = (current, previous) => {
  ...
  var beautifyTimingNumber = (timestamp) => {
  ...
  var findAffectedElement = (affElements, domNode) => {
